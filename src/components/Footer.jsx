...
export default function Footer() {
  ...
  return (
    <footer 
      ...
      className="relative w-full bg-[#050505] text-white overflow-hidden border-t border-white/[0.05] cursor-default"
    >
      {/* 1. Background Grid dengan Masking (Hanya terlihat di dekat konten) */}
      <div 
        className="absolute inset-0 bg-[linear-gradient(to_right,#1a1a1a_1px,transparent_1px),linear-gradient(to_bottom,#1a1a1a_1px,transparent_1px)] bg-[size:5rem_5rem] pointer-events-none"
        style={{ 
      ...
      <div className="relative max-w-7xl mx-auto px-8 pt-32 pb-12 z-10">
        ...
        <div className="flex flex-col items-center text-center mb-32">
          ...
          <p className="text-lg text-gray-500 max-w-xl mb-12 font-light">
          ...
          <div className="w-full max-w-md p-[1px] rounded-full bg-gradient-to-r from-transparent via-[#00dce5]/30 to-transparent transition-all duration-500 hover:via-[#00dce5]/60 focus-within:via-[#00dce5] focus-within:shadow-[0_0_40px_rgba(0,220,229,0.2)]">
            <form className="flex flex-col sm:flex-row gap-2 p-1.5 bg-[#0a0a0a] rounded-full backdrop-blur-md">
              <input 
                type="email" 
                placeholder="Masukkan email bisnis Anda" 
                className="flex-1 bg-transparent outline-none px-6 py-3 text-white placeholder:text-gray-600 text-sm transition-colors"
              />
              <button 
                type="submit" 
                className="group bg-white text-black px-6 py-3 rounded-full font-medium text-sm hover:bg-gray-200 transition-all duration-300 flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(255,255,255,0.1)] whitespace-nowrap"
              >
                Berlangganan
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 py-16 border-t border-white/[0.05]">
          ...
          <div className="space-y-4">
            <h4 className="text-xs font-semibold text-gray-400 uppercase tracking-widest mb-4">Layanan</h4>
            <FooterLink href="/service" label="Integrasi Sistem" />
            <FooterLink href="/service" label="Pengembangan" />
            <FooterLink href="/service" label="Otomatisasi" />
            <FooterLink href="/service" label="Experience" />
          </div>
          
          <div className="space-y-4">
            <h4 className="text-xs font-semibold text-gray-400 uppercase tracking-widest mb-4">Perusahaan</h4>
            <FooterLink href="/" label="About" />
            <FooterLink href="/client" label="Client" />
            <FooterLink href="/service" label="Service" />
          ...
          <div className="space-y-4">
            ...
            <FooterLink href="#" label="Mitra" />
            <FooterLink href="#" label="Privacy" />
            <FooterLink href="#" label="Policy" />
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-white/[0.05] flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="hidden md:flex items-center gap-2 text-xs text-gray-500 bg-white/[0.02] border border-white/5 px-3 py-1.5 rounded-full backdrop-blur-md">
...
function FooterLink({ href, label }) {
  return (
    <a 
      href={href} 
      className="group relative flex items-center gap-2 text-gray-600 hover:text-white transition-all duration-300 text-sm py-1 w-fit"
    >
...
function SocialIcon({ children }) {
  return (
    <a 
      href="#" 
      className="group relative w-10 h-10 flex items-center justify-center rounded-full bg-white/[0.03] border border-white/10 text-gray-500 hover:text-[#050505] hover:bg-[#00dce5] hover:border-[#00dce5] transition-all duration-300 [transform:translateZ(0)] hover:[transform:translateY(-4px)] hover:shadow-[0_10px_20px_rgba(0,220,229,0.3)]"
